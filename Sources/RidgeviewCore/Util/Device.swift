...
public struct Device {
    ...
    static let modelName: String = {
        ...
        return modelName(forIdentifier: identifier)
    }()
    
    static func modelName(forIdentifier identifier: String) -> String { // swiftlint:disable:this cyclomatic_complexity
        #if os(iOS)
        switch identifier {
        ...
        case "i386", "x86_64", "arm64":                       return "Simulator \(modelName(forIdentifier: ProcessInfo().environment["SIMULATOR_MODEL_IDENTIFIER"] ?? "iOS"))"

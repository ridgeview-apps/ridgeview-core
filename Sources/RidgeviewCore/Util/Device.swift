...
// Adapted from: https://medium.com/ios-os-x-development/get-model-info-of-ios-devices-18bc8f32c254
...
public extension Device {
    ...
    static var current: Device {
        mapToDevice(identifier: identifier)
    }
    ...
    static func mapToDevice(identifier: String) -> Device { // swiftlint:disable:this cyclomatic_complexity function_body_length
        ...
        case "i386", "x86_64", "arm64":
            return simulator(mapToDevice(identifier: ProcessInfo().environment["SIMULATOR_MODEL_IDENTIFIER"] ?? "UnknownSimulatorOS"))
    ...
    var modelName: String {
        ...
        case .simulator(let model): return "Simulator (\(model.modelName))"
